...
const FALLBACK_WORK = [
  ...
  {
    id: 'fallback-5',
    title: 'Studio Bottle Series',
    medium: 'product-photography',
    category: 'Product',
    year: 2025,
    camera: 'Sony A7IV · 90mm macro · f/11 · studio strobes',
    image_path: null,
...
// Flat list of every published work item, optionally filtered by medium.
// No grouping — every photo/video/design piece displays as its own tile,
// each in its own native aspect ratio.
